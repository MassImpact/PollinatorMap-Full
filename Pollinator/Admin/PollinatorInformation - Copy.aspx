...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="admincontainer">
        <div style="padding-left: 3px;padding-right: 3px;" >
            ...
            <div style="width: 1039px;  margin-left:7px; font-family: Verdana; font-size: 0.8em; border-collapse: collapse;">
                                ...
                                <div class="6u" >
                                   <div style="float:left;width:49%">
                                    ...
                                    <div style="float:right;width:49%">
                                        Password
                                         <asp:TextBox readonly TabIndex="-1" class="text" BackColor="#dbdbdb" placeholder="Username" ID="txtPassword" runat="server"></asp:TextBox>                                    
                                    </div>
                                </div>
                            ...
                            <div class="row half">
                                ...
                                <div class="6u" >                                       
                                    <div style="float: left; width: 49%">
                                        ...
                                        <asp:RequiredFieldValidator  Display="Dynamic" SetFocusOnError="true"  CssClass="message-error" ID="RequiredFieldValidatorLandscapeZipcode" runat="server" ControlToValidate="txtLandscapeZipcode" ErrorMessage="Zip Code/Country Code is required." ToolTip="Zip Code/Country Code is required." ValidationGroup="Update">Zip Code/Country Code is required.</asp:RequiredFieldValidator>
                            ...
                            <div class="row half">
                                <div class="6u">
                                    <label class="file-upload">
                                        ...
                                        <asp:FileUpload ID="fileToUploadNormal" style="height: 0px;width: 0px;" runat="server" ClientIDMode="Static" onchange="javascript:return fileUploadPhoto('MainContent_txtPhotoUrl', 'MainContent_imgPhoto','loadingNormal', 'fileToUploadNormal', '#validatorPhotoUrl', 'MainContent_linAddPhoto');" />                                        
                                    </label>
                                </div>
                                ...
                                <div class="6u">
                                    ...
                                    <asp:FileUpload ID="fileToUploadNormalVideo" style="height: 0px;width: 0px;" runat="server" ClientIDMode="Static" onchange="javascript:return fileUploadVideo('MainContent_txtYoutubeUrl', 'loadingNormalVideo', 'fileToUploadNormalVideo', '#validatorVideoUrl', 'MainContent_linAddVideo');" />
                                </label>
                ...
                <div  id="divRowRegPremium" style="margin-top:20px;margin-bottom: 20px;" runat="server">
                    <div class="12u">
                        ...
                        <fieldset style="border: 1px #ccc solid;">
                            ...
                            <div class="row half" runat="server" id="Div5">
                                ...
                                <div class="6u">
                                  ...
                                  <asp:TextBox MaxLength="255" ID="txtWebsiteP" runat="server" class="text" placeholder="Website"></asp:TextBox>
                                    <asp:RegularExpressionValidator Display="Dynamic" CssClass="message-error" SetFocusOnError="true" ID="validWebsite"  ControlToValidate="txtWebsiteP"  runat="server" ValidationExpression="(http(s)?://)?([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?" ErrorMessage="Invalid URL" ValidationGroup="Update"></asp:RegularExpressionValidator>                                   
                                </div>
                            </div>
                            ...
                            <div class="row half">
                                ...
                                <div class="6u">
                                    Email Address
                                    <asp:TextBox MaxLength="256"  class="text" ID="txtEmailP" runat="server" placeholder="Email Address"></asp:TextBox><%--TextMode="Email"--%>
                                    <asp:RequiredFieldValidator SetFocusOnError="true" Display="Dynamic" CssClass="message-error" ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtEmailP" ErrorMessage="E-mail Address is required." ToolTip="E-mail Address is required." ValidationGroup="Update">E-mail Address is required.</asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator SetFocusOnError="true" Display="Dynamic" CssClass="message-error" ID="regexEmailValid" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="txtEmailP" ErrorMessage="Invalid email. For example: john@pollinator.org" ValidationGroup="Update"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                             <div class="row half">
                                  <div class="6u" >
                                      <div style="float:left;width:49%">
                                    Username
                                    <asp:TextBox  readonly TabIndex="-1" class="text" BackColor="#dbdbdb" placeholder="Username" ID="txtUserNameP" runat="server"></asp:TextBox>                                    
                                          </div>
                                      <div style="float:right;width:49%">
                                        Password
                                         <asp:TextBox readonly TabIndex="-1" class="text" BackColor="#dbdbdb" placeholder="Password" ID="txtPasswordP" runat="server"></asp:TextBox>                                    
                                    </div>
                                </div>
                               <div class="6u" >
                                    Type of Pollinator Location
                            ...
                            <div class="row half">
                                <div class="6u">
                                    Photo URL
                                    <asp:TextBox  MaxLength="255" ID="txtPhotoUrlP" BackColor="#dbdbdb"  runat="server"  class="text" placeholder="Photo URL" ></asp:TextBox>
                                     <asp:Label id="numPhoto" runat="server"></asp:Label>
                                     <img id="loadingPhotoP" src="../images/loading.gif" style="display: none;">
                                     <span id="validatorPhotoUrlP" class="message-error" style="display: none;"></span>
                                </div>
                                <div class="6u">
                                    Youtube URL
                                      <asp:TextBox  MaxLength="255" ID="txtYoutubeUrlP" BackColor="#dbdbdb" runat="server" class="text" placeholder="Youtube URL"></asp:TextBox>
                            ...
                            <div class="row half"  style="margin-bottom:20px">
                                <div class="6u">                                  
                                     <a href="#Upload_formimage" id="A3"  onclick="openPopup()" class="btnUploadPhoto button btn36" style="font-size: 12px;">Photos</a>

                                </div>
                                <div class="6u"><a href="#Upload_formvideo" id="A5"  onclick="openPopup()" class="button btn36" style="font-size: 12px;">Videos</a> </div>
                            </div>
                             ...
                             <div class="row half" >
                                ...
                                <div class="6u" style="padding-bottom:5px">                                    
                                    <div id="divVideoPlayerP" style="display:none;margin-top:-20px;"></div>
                                </div>                               
                            </div>
                                ...
                                <div class="row half">
                                    <div class="6u">
                                     ...
                                     <div class="6u" ">                                      
                                            ...
                                            <asp:RequiredFieldValidator  Display="Dynamic" SetFocusOnError="true" CssClass="message-error" ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtBillingZipcode" ErrorMessage="Zip Code/Country Code is required." ToolTip="Zip Code/Country Code is required." ValidationGroup="Update">Zip Code/Country Code is required.</asp:RequiredFieldValidator>
     ...
     <script type="text/javascript">
         ...
         <%
         if (divRowRegNormal.Visible)
         {
         %>
         loadingImage = '#loading';
         txtPhotoUrl = '#<%=txtPhotoUrl.ClientID %>';
         imgPhoto = '<%=imgPhoto.ClientID %>';
         linAddPhoto = '<%=linAddPhoto.ClientID %>';
         fileToUploadID = '<%=fileToUploadNormal.ClientID %>';
         ...
         {                          
         %>
         txtPhotoUrl = '#<%=txtPhotoUrlP.ClientID %>';
         ...
         linAddVideo = '<%=linAddVideo.ClientID %>';
         numVideo = '';
         ...
         {                          
         %>
         txtYoutubeUrl = '#<%=txtYoutubeUrlP.ClientID%>';
    ...
    <yb:SingleYoutube runat="server" ID="SingleYoutube"  />
     ...
     <script type="text/javascript">
         ...
         displayImageFirstLoad(txtPhotoUrl);
          <%
         if (divRowRegNormal.Visible)
         {
         %>
         displayVideoOnChange(txtYoutubeUrl, false);
         <%    
         }
         else
         {                          

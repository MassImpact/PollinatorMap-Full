    ...
    <div class="content">
        ...
        <div class="rownor">
            <div class="floatLeft" style="width: 50%; padding-right: 5px">
                <asp:TextBox MaxLength="30" ID="txtLandscapeState" runat="server" class="text" ToolTip="Required" placeholder="State" required></asp:TextBox>
                <asp:RequiredFieldValidator Display="Dynamic" CssClass="message-error" SetFocusOnError="true" ID="rfvLandscapeState" runat="server" ControlToValidate="txtLandscapeState" ErrorMessage="State is required" ToolTip="State is required" ValidationGroup="RegisterUserStep2">State is required</asp:RequiredFieldValidator>
            </div>
            <div class="floatRight" style="width: 50%; padding-left: 5px">
                <asp:TextBox MaxLength="10" ID="txtLandscapeZipcode" runat="server" class="text" ToolTip="Required" placeholder="Zip Code/Postal Code" required></asp:TextBox>
                <asp:RequiredFieldValidator Display="Dynamic" CssClass="message-error" SetFocusOnError="true" ID="rfvLandscapeZipcode" runat="server" ControlToValidate="txtLandscapeZipcode" ErrorMessage="Zip Code/Postal Code is required" ToolTip="Zip Code/Postal Code is required" ValidationGroup="RegisterUserStep2">Zip Code/Postal Code is required</asp:RequiredFieldValidator>
        ...
        <div class="rowtop">
            <div class="floatLeft" style="width: 50%; text-align: center">
                <label class="file-upload">
                    <a class="button btn36" id="linkAddPhoto" runat="server" style="min-width: 190px; font-size: 14px;">Add Image</a>
                    <asp:FileUpload ID="fileToUploadNormal" Style="height: 1px; width: 1px" runat="server" ClientIDMode="Static"
                        onchange="javascript:return fileUploadPhoto(txtPhotoUrl.substr(1), 'imgThumbnailNor','loadingNormal', 'fileToUploadNormal', '#validatorPhotoUrl', linAddPhoto);" />
                </label>
            ...
            <div class="floatRight" style="width: 50%; text-align: center">
                <label class="file-upload">
                    ...
                    <asp:FileUpload Style="height: 1px; width: 1px" ID="fileToUploadNormalVideo" runat="server" ClientIDMode="Static"
                        onchange="javascript:return fileUploadVideo(txtYoutubeUrl.substr(1), 'loadingNormalVideo', 'fileToUploadNormalVideo', '#validatorVideoUrl', linkAddVideo);" />
                </label>
...
<script type="text/javascript">
    ...
    var linAddPhoto = '<%=linkAddPhoto.ClientID%>';
    ...
    var linkAddVideo = '<%=linkAddVideo.ClientID%>';

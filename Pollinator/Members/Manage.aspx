            ...
            <div class="row" runat="server" id="divRowRegNormal" style ="margin-top: 50px;">
                <div class="12u" style ="margin-left: -50px;">
                    ...
                    <fieldset style="border: 1px #ccc solid;">
                        ...
                        <div class="row half">
                            <div class="6u">
                                <asp:TextBox MaxLength="30" ID="txtNorLandscapeState" runat="server" class="text" ToolTip="Landscape State" placeholder="Landscape State" required></asp:TextBox>
                                <asp:RequiredFieldValidator Display="Dynamic" CssClass="message-error" SetFocusOnError="true" ID="rfvNorLandscapeState" runat="server" ControlToValidate="txtNorLandscapeState" ErrorMessage="Landscape State is required." ToolTip="Landscape State is required." ValidationGroup="CreateUserWizard1">Landscape State is required.</asp:RequiredFieldValidator>
                            </div>
                            <div class="6u" style="display: inline-flexbox;">
                                <div style="float: left; width: 49%">
                                    <asp:TextBox MaxLength="10" ID="txtNorLandscapeZipcode" runat="server" class="text" ToolTip="Landscape Zipcode" placeholder="Landscape Zipcode" required></asp:TextBox>
                                ...
                                <asp:RequiredFieldValidator Display="Dynamic" CssClass="message-error" SetFocusOnError="true" ID="rfvNorLandscapeZipcode" runat="server" ControlToValidate="txtNorLandscapeZipcode" ErrorMessage="Zip Code/Country Code  is required." ToolTip="Zip Code/Country Code  is required." ValidationGroup="CreateUserWizard1">Zip Code/Country Code  is required.</asp:RequiredFieldValidator>
                        ...
                        <div class="row half">
                            <div class="6u">
                                 <label class="file-upload">
                                        <a class="button btn36" id="linAddPhoto" runat="server" style="min-width: 180px; font-size: 14px;">Add Photo</a>
                                        <asp:FileUpload ID="fileToUploadNormal" style="height:1px; width:1px"  runat="server" ClientIDMode="Static" onchange="javascript: var uploadPhotoUserFolder = document.getElementById('MainContent_HiddenUploadUserFolder_Photo').value; return fileUploadPhoto('MainContent_txtNorPhotoUrl', 'MainContent_imgPhoto','loadingNormal', 'fileToUploadNormal', '#validatorPhotoUrl', 'MainContent_linAddPhoto', uploadPhotoUserFolder)" />                                        
                                 </label>
                            ...
                            <div class="6u">
                                 <label class="file-upload">
                                    <a class="button btn36" id="linAddVideo"  runat="server" style="min-width: 180px; font-size: 14px;">Add Video</a>
                                    <asp:FileUpload ID="fileToUploadNormalVideo" style="height:1px; width:1px" runat="server" ClientIDMode="Static" onchange="javascript: var uploadVideoUserFolder = document.getElementById('MainContent_HiddenUploadUserFolder_Video').value; return fileUploadVideo('MainContent_txtNorYoutubeUrl', 'loadingNormalVideo', 'fileToUploadNormalVideo', '#validatorVideoUrl', 'MainContent_linAddVideo', uploadVideoUserFolder);" />
                                </label>
